...
from app.schemas.card import CardReadSchema, CardSchema
from app.engine.utils.unit_of_work import UnitOfWork


class CardService:

    async def get_card(self, card_id: UUID) -> CardReadSchema | None:
